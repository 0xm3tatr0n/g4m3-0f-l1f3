...
contract G4m3 {
  ...
  function generateSVGofTokenById(uint256 id) internal view returns (string memory) {
    ...
    function generateColorMap(Structs.MetaData memory metadata) internal pure returns (Structs.ColorMap memory){
  ...
  // combine array of squares into single bytes array
    ...
    function gridToWord(bool[dim][dim] memory grid) pure internal returns(uint256){
